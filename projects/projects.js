fetch('projects/projects.html').then(r => r.text()).then(html => {
    ...
    const projects = [
        { title: 'CrewsOutThere', asset: 'projects/assets/placeholder.png', 
        ...
        { title: 'Multi-Spectral Rendering', asset: 'projects/assets/placeholder.png',
        ...
        { title: 'Cellular Automota', asset: 'projects/assets/placeholder.png',
