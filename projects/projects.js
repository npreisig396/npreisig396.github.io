fetch('projects/projects.html').then(r => r.text()).then(html => {
    ...
    const projects = [
        { title: 'DeepNeuralNetwork', asset: 'assets/projects/nn.mp4',
        ...
        { title: 'Multi-Spectral Rendering', asset: 'assets/projects/rays.png',
        ...
        { title: 'Cellular Automota', asset: 'assets/projects/automota.js',
        ...
        { title: 'CrewsOutThere', asset: 'assets/projects/crew.mp4', 
